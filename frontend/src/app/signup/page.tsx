    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="md:hidden bg-gradient-to-br from-brand-black to-gray-900 text-brand-lime p-6">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-base text-gray-400 font-light tracking-wide">Transform your productivity</p>
        </div>
      </div>
        ...
        <div className="bg-brand-card p-6 md:p-8 rounded-3xl shadow-2xl w-[90%] max-w-md">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-gray-50 border-0 p-4 rounded-2xl focus:ring-2 focus:ring-brand-lime pr-12"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full font-bold px-6 py-3 rounded-full shadow-sm transition-all active:scale-95 ${
                isLoading
