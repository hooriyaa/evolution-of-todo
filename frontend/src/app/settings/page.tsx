  ...
  return (
    <div className="max-w-6xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-gradient-to-r from-brand-black to-gray-900 rounded-3xl p-6 text-white border border-white/10 shadow-2xl">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-gray-300 mt-1">{userData?.email || 'email@example.com'}</p>
        ...
        <div className="bg-brand-purple/20 rounded-3xl p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">About App</h3>
        ...
        <div className="md:col-span-2 bg-red-50 rounded-3xl p-6 border border-red-100">
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-xl transition-colors font-medium text-sm"
            >
              Sign Out
            </button>
             </div>
